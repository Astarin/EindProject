...
namespace EindProjectBusinessModels
{
    class DbEindprojectInitializer : DropCreateDatabaseAlways<DbEindproject>
    {
        protected override void Seed(DbEindproject db)
        {
            ...
            smurf8.Verlofaanvragen.Add(MaakVerlofAanvraag(new DateTime(2015, 02, 28), new DateTime(2015, 08, 12), new DateTime(2015, 08, 19), Aanvraagstatus.Ingediend, null, null, 6));
            smurf16.Verlofaanvragen.Add(MaakVerlofAanvraag(new DateTime(2015, 02, 28), new DateTime(2015, 08, 12), new DateTime(2015, 08, 19), Aanvraagstatus.Ingediend, null, null, 6));
